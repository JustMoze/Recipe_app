    ...
    private class getDesert extends AsyncTask<Integer, Void, Boolean> {
        ...
        protected Boolean doInBackground(Integer... integers) {
            ...
            try {
                ...
                String sql = "SELECT recipe._ID, recipe.NAME, recipe.DURATION, recipe.IMAGE FROM `recipe` INNER JOIN recipe_category ON recipe._ID = recipe_category.recipe_ID INNER JOIN category ON category._ID = recipe_category.category_ID AND category.NAME = 'Desert'";
