...
public class Breakfast_fragment extends Fragment {
    private List<Recipe> breakfastRecipes = new ArrayList<Recipe>();
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        int randNumber = 7;
        new getBreakfast().execute(randNumber);
        adapter = new RecipesAdapter(breakfastRecipes);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter.setListener(position -> {
            int recipe_ID = breakfastRecipes.get(position)._id;
    ...
    private class getBreakfast extends AsyncTask<Integer, Void, Boolean> {
