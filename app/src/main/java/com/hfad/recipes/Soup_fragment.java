    ...
    private class getSoups extends AsyncTask<Integer, Void, Boolean> {
        ...
        protected Boolean doInBackground(Integer... integers) {
            ...
            try {
                ...
                String sql = "SELECT recipe._ID, recipe.NAME, recipe.DURATION, recipe.IMAGE FROM `recipe` INNER JOIN category WHERE recipe._ID = category.RECIPE_ID AND category.NAME = 'Soup'";
