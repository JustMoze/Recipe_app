...
public class Soup_fragment extends Fragment {
    private List<Recipe> soupRecipes = new ArrayList<Recipe>();
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        int randNumber = 7;
        new getSoups().execute(randNumber);
        adapter = new RecipesAdapter(soupRecipes);
    ...
    private class getSoups extends AsyncTask<Integer, Void, Boolean> {
        ...
        protected Boolean doInBackground(Integer... integers) {
            ...
            try {
                ...
                String sql = "SELECT recipe._ID, recipe.NAME, recipe.DURATION, recipe.IMAGE FROM `recipe` INNER JOIN recipe_category ON recipe._ID = recipe_category.recipe_ID INNER JOIN category ON category._ID = recipe_category.category_ID AND category.NAME = 'Soup'";
